      ...
      <div className='container mx-auto min-h-[800px] mb-14'>
        ...
        <div className='flex flex-col items-start gap-8 lg:flex-row'>
              <div className='max-w-[768px]'>
                <div className='mb-8'>
                  <img src={house.imageLg} alt="Large Image of House" />
                </div>
            ...
            <div className='flex items-center gap-x-4 mb-8'>
              ...
              <form  className='flex flex-col gap-y-4'>
                ...
                <textarea className='border border-gray-300 focus:border-violet-700
                  ...
                  placeholder='Message*' defaultValue='Hello I am Inerested In [Modern Apartment]'>
                </textarea>
                  <div className='flex gap-x-2'>
                    <button className='bg-violet-700 hover:bg-violet-800 rounded p-4
                      text-white w-full transition'>
                      Send Message
                    </button>
